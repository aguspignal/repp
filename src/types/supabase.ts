  ...
  public: {
    Tables: {
      ...
      RoutineDayExercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "RoutineDayExercises_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
            referencedRelation: "Exercises"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "RoutineDayExercises_routineday_id_fkey"
            columns: ["routineday_id"]
            isOneToOne: false
            referencedRelation: "RoutineDays"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      RoutineSchedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "RoutineSchedules_routineday_id_fkey"
            columns: ["routineday_id"]
            isOneToOne: false
            referencedRelation: "RoutineDays"
            referencedColumns: ["id"]
      ...
      WorkoutSets: {
        ...
        Relationships: [
          {
            foreignKeyName: "WorkoutSets_progression_id_fkey"
          ...
          {
            foreignKeyName: "WorkoutSets_workout_id_fkey"
            columns: ["workout_id"]
            isOneToOne: false
